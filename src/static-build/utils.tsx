...
export const siteOrigin = (() => {
  ...
  if (process.env.CONTEXT === 'production') return 'https://pic.ljxmc.top';
  if (process.env.DEPLOY_PRIME_URL) return process.env.DEPLOY_PRIME_URL;
  console.warn(
    'Unable to determine site origin, defaulting to https://pic.ljxmc.top',
  );
  return 'https://pic.ljxmc.top';
})();
